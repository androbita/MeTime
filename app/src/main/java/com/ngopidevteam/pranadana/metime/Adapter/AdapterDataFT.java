...
public class AdapterDataFT extends RecyclerView.Adapter<AdapterDataFT.HolderData> {

    private List<ModelData> mItems;
    private HistoryFT context;

    public AdapterDataFT(HistoryFT context, List<ModelData> items){
